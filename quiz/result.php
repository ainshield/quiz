...
$userAnswers = $_POST['answers'] ?? []; //  answers[questionId] = selectedAnswer
$quizQuestions = $_SESSION['quiz_questions'] ?? []; // Load the questions from the session.
...
if ($username) {
    $stmt = $conn->prepare("INSERT INTO scores (username, score, total_questions) VALUES (?, ?, ?)");
